...
export class AppointmentsService extends BaseService {
   ...
   */
  static readonly AppointmentsControllerPutAppointmentPath = '/appointments';
  ...
  appointmentsControllerPutAppointment$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AppointmentsService.AppointmentsControllerPutAppointmentPath, 'put');
    if (params) {
